...
public class EnterPinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        existingPin = getIntent().getStringExtra("pin_code");
        userName = getIntent().getStringExtra("userName");
        avatarUrl = getIntent().getStringExtra("avatarUrl");

        subtitle.setVisibility(View.VISIBLE);
        subtitle.setText((existingPin != null && !existingPin.isEmpty())
        ...
        forgotPin.setOnClickListener(v -> {
            Intent intent = new Intent(EnterPinActivity.this, VosstanovlPinKodaActivity.class);
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length() == 4) {
                    ...
                    if (existingPin != null && !existingPin.isEmpty()) {
                        if (s.toString().equals(existingPin)) {
                            ...
                            Toast.makeText(EnterPinActivity.this, "Неверный PIN-код, попробуйте снова", Toast.LENGTH_SHORT).show();
                            pinInput.setText("");
                        }
                    } else {
